...
//   #define NCP_SPI_DEVICE              "/dev/spidev1.0"
// #endif

char spiDevArg[20] = {0};
char chipSelectGpioArg[5] = {0};
char intGpioArg[5] = {0};
char resetGpioArg[5] = {0};
char wakeGpioArg[5] = {0};
  ...
  #define NCP_SPI_SPEED_HZ            (1000 * 1000) // 1 MHz
#endif

// #ifndef NCP_CHIP_SELECT_GPIO
//   #define NCP_CHIP_SELECT_GPIO          "45"
// #endif

// #ifndef NCP_HOST_INT_GPIO
//   #define NCP_HOST_INT_GPIO             "2"
// #endif

// #ifndef NCP_RESET_GPIO
//   #define NCP_RESET_GPIO                "43"
// #endif

// #ifndef NCP_WAKE_GPIO
//   #define NCP_WAKE_GPIO                 "48"
// #endif
...
void halNcpSendRawCommand(void)
{
  ...
  int num = 0;
  emberAfCorePrint("sendingCommand: ");
  for(;num < length; num++)
  {
	emberAfCorePrint("0x%02x ", halNcpSpipBuffer[num]);
  } 
  emberAfCorePrint("\n");
