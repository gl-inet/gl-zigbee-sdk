...
EmberStatus emberJoinNetworkDirectly(EmberNodeType localNodeType,
 ...
 #define emberJoinNetworkDirectly(...) EMBER_ERR_FATAL
...
uint8_t emberGetNumStoredBeacons(void);
 ...
 #define emberSetNumBeaconsToStore(numBeacons) EMBER_ERR_FATAL; (void)numBeacons
 #define emberGetFirstBeacon(beaconIterator)   EMBER_ERR_FATAL; (void)beaconIterator
 #define emberGetNextBeacon(beacon)            EMBER_ERR_FATAL; (void)beacon
 #define emberGetNumStoredBeacons(...)         0
#endif // defined(EMBER_USE_BEACON_CACHE) || defined(EMBER_AF_PLUGIN_NETWORK_STEERING_OPTIMIZE_SCANS)
