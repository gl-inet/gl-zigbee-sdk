...
// frame counter as found in the Network Auxiliary header for the specfied
// neighbor or child
...
// stack changes. NOTE: this API is not safe to call on multi-network devices
// and it will return failure when so. Use of the ember/ezspSetRadioChannel APIs
// are multi-network safe and are recommended instead.
// Return: An EmberStatus value indicating success or the reason for failure.
